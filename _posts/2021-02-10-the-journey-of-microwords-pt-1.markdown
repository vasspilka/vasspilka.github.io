...
While the project was initially inspired by the forementioned idea, it has since parted and evolved into a project of it's own and is turning out very different. It is still early to say what exactly this project will end up being, however the idea of an alternative content sharing platform is really intriguing to me. In today's world, social media and content platform mostly attempt to grab ones attention with flashy titles, viral bits and cheap content, discoverability and exploration have become a rarer thing in todays web. I'd like to help build a platform that brings back some of the joy of exploration and discoverability.
